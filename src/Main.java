public class Main {
    public static void main(String[] args) {
        ...
        // Создаем абонементы
        Membership membership1 = new Membership(Type.FULL,Zone.GYM,1,owner1,"22-05-2025 12:12:12");
        Membership membership2 = new Membership(Type.FULL, Zone.GROUP, 2, owner2,"22-05-2025 12:12:12");
